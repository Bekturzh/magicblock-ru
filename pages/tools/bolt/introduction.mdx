...
<CardGroup cols={2}>
  <Card title="Installation" icon="bolt" iconType="duotone" href="/pages/tools/bolt/getting-started/installation">
...
To build a game or an application onchain, you'll need to familiarize with Solana programs (smart contracts). You might be already familiar with [Anchor](https://www.anchor-lang.com/), one of the most used toolkit for writing smart contract on Solana.
