...
description: "Интеграция и управление сессиями в ваших программах Solana"
---
...
3. Определение аккаунта сессионного токена:
...
4. Использование макроса **session_auth_or**:
...
2. Сохраните программу Session Keys в локальный файл:

```
solana program dump KeyspM2ssCJbqUhQ4k7sveSiY4WjnYsrXkC8oDbwde5 ./session-keys.so
```

3. Запустите **solana-test-validator** с программой и аккаунтом сессионных ключей:
