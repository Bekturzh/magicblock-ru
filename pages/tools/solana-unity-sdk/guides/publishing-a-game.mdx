...
- Open [Build Settings](https://docs.unity3d.com/Manual/BuildSettings.html) window and change to WebGL platform if you haven't already:
  ...
  - Click the **Switch Platform** button to apply changes. <img src="/images/switch_platform.png" alt="" />
...
If you haven't already, go get your Backpack user. You can download Backpack [here](https://www.backpack.app/downloads). After you have your game hosted in a webserver and you have Backpack account, you can just go to https://www.xnft.gg/publish to deploy your xnft in mainnet-beta or https://devnet.xnft.gg/publish to deploy the xnft in devnet.
