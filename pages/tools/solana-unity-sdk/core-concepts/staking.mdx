---
title: "Стейкинг"
description: "Владельцы токенов **SOL** могут получать вознаграждения и помогать обеспечивать безопасность сети, делегируя токены одному или нескольким валидаторам. Вознаграждения за стейкинг зависят от текущего уровня инфляции, общего количества SOL, делегированных в сети, а также от времени активности и комиссии (fee) конкретного валидатора.
"
---

Подробнее о стейкинге можно узнать в официальной документации (Solana [documentation](https://spl.solana.com/stake-pool/overview#staking))
