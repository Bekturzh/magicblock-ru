...
description: "Узнайте о **подписях** в официальной документации Solana: [Solana Documentation](https://docs.solana.com/developing/programming-model/accounts#signers)
"
---
