---
title: "Связанный токен-аккаунт"
description: "Программа Связанный токен-аккаунт определяет конвенцию и предоставляет механизм для сопоставления адреса кошелька пользователя с связанными токен-аккаунтами, которые он держит.
"
---

Для полного обзора  Связанных токен-аккаунтов  можно воспользоваться официальной  [документацией](https://spl.solana.com/associated-token-account) Solana.
