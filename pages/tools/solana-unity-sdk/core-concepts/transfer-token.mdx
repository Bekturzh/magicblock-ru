...
description: "Программа **Token** определяет общую реализацию для фиатных (Fungible) и невзаимозаменяемых (Non-Fungible) токенов.
"
---

Подробнее о программе **Token** можно узнать в официальной документации ( Solana [documentation](https://spl.solana.com/token).)

Баланс можно переводить между аккаунтами с помощью инструкции **Transfer**. Владелец исходного аккаунта должен присутствовать как подписант в инструкции **Transfer**, если исходный и целевой аккаунты различаются.
