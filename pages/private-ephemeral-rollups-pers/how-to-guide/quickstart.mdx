...
<Columns cols={2}>
  <Card title="Контроль доступа" icon="lock" iconType="duotone" href="/pages/private-ephemeral-rollups-pers/how-to-guide/access-control">
    Гибко настраиваемый контроль доступа
  </Card>
  <Card title="Конфиденциальность в блокчейне" icon="user-helmet-safety" href="/pages/private-ephemeral-rollups-pers/introduction/onchain-privacy">
  ...
  <Card title="Система обеспечения соответствия требованиям" icon="glasses-round" iconType="duotone" href="/pages/private-ephemeral-rollups-pers/introduction/compliance-framework">
