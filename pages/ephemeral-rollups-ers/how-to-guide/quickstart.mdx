...
<Tabs>
  ...
  <Tab title="Magic Action">
    ...
    <CardGroup cols={2}>
      <Card title="Magic Actions Example" icon="code" iconType="duotone" href="https://github.com/magicblock-labs/magicblock-engine-examples/tree/main/magic-actions">
        Explore reference implementation on GitHub
      </Card>
    </CardGroup>
    Attach one or more instructions that run automatically on the Solana base layer immediately after an Ephemeral Rollup (ER) commit. [Learn more about Magic Action](/pages/ephemeral-rollups-ers/magic-actions/overview.mdx)
