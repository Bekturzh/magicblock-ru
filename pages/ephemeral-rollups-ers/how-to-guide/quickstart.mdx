...
<Columns cols={2}>
  <Card title="Ephemeral Rollup (ER)" icon="poo-storm" iconType="duotone" href="/pages/ephemeral-rollups-ers/how-to-guide/quickstart">
    Выполнение транзакций в реальном времени без комиссий и с высокой безопасностью в сети Solana.
  </Card>
  <Card title="Private Ephemeral Rollup (PER)" icon="user-helmet-safety" href="/pages/private-ephemeral-rollups-pers/how-to-guide/quickstart">
    Защита конфиденциальных данных с помощью приватных вычислений.
  </Card>
  <Card title="Verifiable Randomness Function (VRF)" icon="random" href="/pages/verifiable-randomness-functions-vrfs/how-to-guide/quickstart">
