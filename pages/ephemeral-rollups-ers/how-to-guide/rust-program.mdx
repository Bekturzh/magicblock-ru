...
<Steps>
  ...
  <Step title={<a href="#2-delegate">Делегируйте PDA на Base Layer</a>}>
  ...
  <Step title={<a href="#3-commit">Закомитьте PDA на ER</a>}>
    Разверните вашу программу напрямую на Solana с помощью Solana CLI.
  </Step>
  <Step title={<a href="#4-undelegate">Отмените делегирование PDA на ER</a>}>
