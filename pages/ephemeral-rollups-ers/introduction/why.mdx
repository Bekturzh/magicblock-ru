...
<Card>
  ...
  Rollup](/pages/ephemeral-rollups-ers/introduction/ephemeral-rollup) is an extension of the Solana network designed for high-performance decentralized applications. It enhances Solana’s capabilities while preserving its composability and integrity.
</Card>
...
<CardGroup cols={2}>
  <Card title="Ephemeral Rollup" icon="bolt" iconType="duotone" href="/pages/ephemeral-rollups-ers/introduction/ephemeral-rollup">
  ...
  <Card title="Quickstart" icon="hammer" iconType="duotone" href="/pages/ephemeral-rollups-ers/how-to-guide/quickstart">
    Try out with Rust, Anchor, and Typescript
  </Card>
  <Card title="Privacy" icon="shield-check" iconType="duotone" href="/pages/private-ephemeral-rollups-pers/introduction/onchain-privacy">
